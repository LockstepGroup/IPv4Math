#
# Module manifest for module 'IPv4Math'
#
...
@{
    ...
    Description       = 'IPv4 Math functions, originally from http://wwwindented.co.uk/index.php/2010/01/23/powershell-subnet-math/'
